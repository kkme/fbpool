// CVS ID: @(#) $Id: PersistWeeklyResults.java,v 1.1.1.1 2005-08-25 18:13:09 husker Exp $

package com.talient.football.util.results;
 ...
 * @version $Version: $
 */
public class PersistWeeklyResults {

    private PersistWeeklyResults() {};

    public PersistWeeklyResults(int year, int week) 
        throws Exception {
        ...
        if (! crosstable.getSchedule().allGamesValidated()) {
            throw new Exception("All games have not been validated for week " + 
                                week + ", " + year);
        }
    ...
    public static void main(String[] args) {
        ...
        String usage = "Usage: com.talient.football.util.entry.PersistWeeklyResults " +
            "<year> <week> [persist]";
        ...
        try {
            PersistWeeklyResults sw = new PersistWeeklyResults(year, week);
        }
        catch (Exception e) {
