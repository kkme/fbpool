...
<%@ page import="com.talient.football.publish.PublishRecap" %>
...
String pHref = "";
try {
    String path = PublishRecap.publish(Integer.parseInt(year),
                                       Integer.parseInt(week));
    int idx = path.indexOf(year);
    pHref = "/" + path.substring(idx);
    pStr.append("The recap has been published to ");
}
catch (Exception e) {
...
<HEAD>
<TITLE>
<%= Properties.getProperty("football.pool.name") %> Published Recap</TITLE>
