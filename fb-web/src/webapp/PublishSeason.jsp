...
<%@ page import="com.talient.football.publish.PublishSeason" %>
...
String pHref = "";
try {
    String path = PublishSeason.publish(Integer.parseInt(year));
    int idx = path.indexOf(year);
    pHref = "/" + path.substring(idx);
    pStr.append("The Season index.htm file has been published to ");
}
catch (Exception e) {
...
<HEAD>
<TITLE>
<%= Properties.getProperty("football.pool.name") %> Published Season</TITLE>
